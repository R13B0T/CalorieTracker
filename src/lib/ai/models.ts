...
export const KNOWN_MODELS: ModelOption[] = [
  { id: 'claude-haiku-4-5', label: 'Haiku 4.5', hint: 'Cheapest and fastest. Great for text, weaker on photos.' },
  { id: 'claude-sonnet-5', label: 'Sonnet 5', hint: 'Best value for photos. Recommended.' },
  { id: 'claude-opus-5', label: 'Opus 5', hint: 'Sharper on tricky plates. Roughly 2.5x the cost of Sonnet.' },
  { id: 'claude-fable-5-1', label: 'Fable 5.1', hint: 'Top of the range. Overkill for lunch, but your call.' },
];
