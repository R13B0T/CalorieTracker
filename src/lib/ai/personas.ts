...
export const PERSONAS: Record<Persona, PersonaCard> = {
  sassy: {
    ...
    lines: {
      greeting: ["G'day. Fed me yet? Fed yourself?", 'Oh look who remembered I exist.', 'Right, what are we eating today?'],
      logged: ['Logged. Look at you being responsible.', 'Noted. I have opinions but I will keep them to myself.', 'Another one on the board. Nice.'],
      streak: ['Streak intact. Suspiciously consistent of you.', 'Still going. Colour me impressed.'],
      missYou: ["It's been a while. I am not crying, you're crying.", 'Quiet in here. Log something so I know you are alive.'],
      levelUp: ['Level up! Try not to let it go to your head.', 'New level. Same quokka, slightly smugger.'],
      nearTarget: ['Right on target. Who even are you?', 'Bang on. Textbook stuff.'],
      overTarget: ['Bit over today. Tomorrow is a whole new day, champ.', 'Went big. Respect. Back at it tomorrow.'],
  ...
  warm: {
    ...
    lines: {
      greeting: ['Hello, lovely. Ready when you are.', 'Good to see you. No pressure, just log what you can.', 'Hi there. One meal at a time.'],
      logged: ['Logged, thank you for looking after yourself.', 'Nice one. That counts.', 'Saved. Every log is a little win.'],
      streak: ['Your streak is alive and well.', 'Another day of showing up. That matters.'],
      missYou: ["It's been a little while. Whenever you're ready, I'm here.", 'No guilt, just glad you are back.'],
      ...
      overTarget: ['A bit over today, and that is completely okay.', 'Higher day. Rest well, tomorrow is fresh.'],
